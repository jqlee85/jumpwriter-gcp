...
class LoadingIcons extends Component {
  ...
  render(){
    return <div className="prompt-types jo-chasing-icons">
      ...
      <button className="prompt-type-button prompt-image-button jo-chasing-icon jo-icon-2" onClick={this.imagePrompt}><CameraIcon iconWidth="30px" color="#fff" hoverColor="#3ae0b1" /></button>
    </div>
  }
